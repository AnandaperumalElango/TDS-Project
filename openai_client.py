...
# AIPROXY_TOKEN = openai.OpenAI(api_key=os.getenv("OPENAI_API_KEY"))
# import os
# import openai
# import httpx
# import json
...
# # Print Response (Corrected)
# print(response.choices[0].message.content)

# # Remove incorrect assignment of AIPROXY_TOKEN
# AIPROXY_TOKEN = os.getenv("OPENAI_API_KEY")  # Use this if needed elsewhere
